...
import { SelectionsTable } from "./PropertyTable/SelectionsTable";
import { useSelections } from "../hooks/useSelection";
import type { Realtor } from "../types";

interface RealtorSelectionsProps {
  user: Realtor;
}

const RealtorSelections: React.FC<RealtorSelectionsProps> = ({ user }) => {
...
export default RealtorSelections;
